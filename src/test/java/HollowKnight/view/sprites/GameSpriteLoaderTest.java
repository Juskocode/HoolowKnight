...
class GameSpriteLoaderTest {
    ...
    public void get() throws IOException {
        ...
        String filepath1 = "sprite/sprite1.png";
        URL resource1 = getClass().getClassLoader().getResource("sprite/sprite1.png");
        assertNotNull(resource1);
        BufferedImage image1 = ImageIO.read(new File(resource1.getFile()));

        String filepath2 = "sprite/sprite2.png";
        URL resource2 = getClass().getClassLoader().getResource("sprite/sprite2.png");
