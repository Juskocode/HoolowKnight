...
public class EnergyOrbViewer implements ElementViewer<EnergyOrb> {
    ...
    public EnergyOrbViewer() throws IOException {
        this.energyOrbSprite = new Sprite("sprites/" +
                "collectables/energy.png");
    }
    @Override
    public void draw(EnergyOrb model, GUI gui, long time, int offsetX, int offsetY) throws IOException {
